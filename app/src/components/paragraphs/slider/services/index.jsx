...
const SliderServices = ({ multicolor_title, paragraphs, description }) => {
  ...
  return (
    <div className="slider-services">
      ...
      <div className="container">
        ...
        <div className="slider-services__swiper">
          <Swiper
          ...
          >
            {paragraphs?.items?.length > 0 &&
              paragraphs.items.map(item => {
                ...
                return (
                  <SwiperSlide key={id}>
                    <div className="slider-services__item">
                      ...
                      <div className="slider-services__item-content">
